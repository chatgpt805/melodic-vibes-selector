...
import { Send, ImagePlus, Smile, Youtube, Facebook, Instagram, Music, Star, ArrowLeft } from "lucide-react";
...
const FullPageChatbot: React.FC<FullPageChatbotProps> = ({ onClose }) => {
