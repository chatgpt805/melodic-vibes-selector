...
const ChatbotSuggestions: React.FC = () => {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (imagePreview) {
        // This is where we would normally use DeepSeek API to analyze the image
        ...
        // Simulate artist information for the suggestion
        artistInfo = {
          name: detectedEmotion === "happy" ? "Pharrell Williams" : 
                detectedEmotion === "sad" ? "Adele" : 
                detectedEmotion === "energetic" ? "Daft Punk" : "Enya",
          imageUrl: `https://i.pravatar.cc/150?u=${detectedEmotion}` // Random avatar based on emotion
        };
